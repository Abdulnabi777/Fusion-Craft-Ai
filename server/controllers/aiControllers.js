...
export const  resumeReview = async (req, res) => {
    try {
        ...
        const prompt = `Review this resume and provide feedback on its strengths, weaknesses, and areas for improvement, including ATS compatibility and overall presentation for better professional impact. Resume Content:\n\n${pdfData.text}`
